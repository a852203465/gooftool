...
public class FtpClientTemplate {
    ...
    private Boolean uploadFile(InputStream inputStream, String remoteDirectory, String remoteFileName) {
        ...
        try {
            ...
            log.error("Can't upload {}/{}, Exception : {}", remoteDirectory, remoteFileName, e.getMessage());
        }finally {
            close(inputStream);
    ...
    private Boolean appendFile(InputStream inputStream, String remoteDirectory, String remoteFileName) {
        ...
        try {
            ...
            log.error("Can't append {}/{}, Exception : {}", remoteDirectory, remoteFileName, e.getMessage());
        }finally {
            close(inputStream);
            returnObject(ftpClient);
        }
    ...
    public Boolean deleteFile(String pathName) {
        ...
        try {
            ...
            log.error("Can't delete {}, Exception : {}", pathName, e.getMessage());
        }finally {
            returnObject(ftpClient);
        }
    ...
    public String getSize(String pathName) throws FtpClientException {
        ...
        try {
           ...
           return ftpClient.getSize(pathName);
            ...
            log.error("Can't getSize {}, Exception : {}", pathName, e.getMessage());
    ...
    public String getStatus(String pathName) throws FtpClientException {
        ...
        try {
            ...
            log.error("Can't getStatus {}, Exception : {}", pathName, e.getMessage());
            throw new FtpClientException(e);
        }finally {
            returnObject(ftpClient);
        }
    ...
    public String getSystemType() throws FtpClientException {
        ...
        try {
            ...
            log.error("Can't getSystemType, Exception : {}", e.getMessage());
            throw new FtpClientException(e);
        }finally {
            returnObject(ftpClient);
        }
    ...
    public List<FTPFile> listFiles(String pathName, FTPFileFilter filter) {
        ...
        try {
            ...
            log.error("Cannot obtain all files of {}, Exception : {}", pathName, e.getMessage());
            throw new FtpClientException(e);
        }finally {
            returnObject(ftpClient);
        }
    ...
    public Boolean removeDirectory(String pathName) {
        ...
        try {
            ...
            log.error("Can't remove directory {}, Exception : {}", pathName, e.getMessage());
        }finally {
            returnObject(ftpClient);
        }
    ...
    public Boolean rename(String srcPathName, String targetPathName) {
        ...
        try {
            ...
            log.error("Can't rename {}, Exception : {}", srcPathName, e.getMessage());
        }finally {
            returnObject(ftpClient);
        }
    ...
    public byte[] downloadFile(String remote) throws FtpClientException {
        ...
        try {
            ...
            log.error("Can't download {}, Exception : {}", remote, e.getMessage());
            throw new FtpClientException(e);
        }finally {
            returnObject(ftpClient);
        }
    ...
    private boolean changeWorkingDirectory(FTPClient ftpClient, String dir) {
        ...
        try {
            ...
            log.error("changeWorkingDirectory {}", e.getMessage());
        }
        return false;
    }
