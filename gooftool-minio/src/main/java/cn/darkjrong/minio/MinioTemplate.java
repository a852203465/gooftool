...
public class MinioTemplate {
    ...
    public Boolean bucketExists(String bucketName) {
        ...
        try {
            ...
            log.error("判断bucket是否存在异常 {}", e.getMessage());
        }
    ...
    public StatObjectResponse statObject(String bucketName, String objectName, String versionId) throws MinioException {
        ...
        try {
            ...
            log.error("获取对象信息异常 {}", e.getMessage());
    ...
    public String getObjectUrl(String bucketName, String objectName, int duration, TimeUnit unit) throws MinioException {
        ...
        try {
            ...
            log.error("获取对象URL异常 {}", e.getMessage());
    ...
    public List<Bucket> listBuckets() throws MinioException {
        ...
        try {
            ...
            log.error("获取bucket集合异常 {}", e.getMessage());
    ...
    public Boolean makeBucket(String bucketName, boolean objectLock) {
        ...
        try {
            ...
            log.error("创建 bucket 异常 {}", e.getMessage());
        }
    ...
    public Boolean setBucketVersion(String bucketName,
        ...
        try {
            ...
            log.error("设置bucket版本异常 {}", e.getMessage());
        }
    ...
    public VersioningConfiguration getBucketVersion(String bucketName) throws MinioException {
        ...
        try {
            ...
            log.error("获取bucket版本异常 {}", e.getMessage());
    ...
    public Boolean setObjectLockConfiguration(String bucketName, RetentionMode retentionMode, int duration, boolean isDays) {
        ...
        try {
            ...
            log.error("设置对象锁配置异常 {}", e.getMessage());
        }
    ...
    public Boolean deleteObjectLockConfiguration(String bucketName) {
        ...
        try {
            ...
            log.error("删除对象锁配置异常 {}", e.getMessage());
        }
    ...
    public ObjectLockConfiguration getObjectLockConfiguration(String bucketName) throws MinioException {
        ...
        try {
            ...
            log.error("获取对象锁配置异常 {}", e.getMessage());
    ...
    public Boolean setObjectRetention(String bucketName, String objectName, RetentionMode retentionMode, ZonedDateTime zonedDateTime, boolean bypassGovernanceMode) {
        ...
        try {
            ...
            log.error("设置对象保留时间异常 {}", e.getMessage());
        }
    ...
    public Retention getObjectRetention(String bucketName, String objectName) throws MinioException {
        ...
        try {
            ...
            log.error("获取对象保留信息异常 {}", e.getMessage());
    ...
    public Boolean enableObjectLegalHold(String bucketName, String objectName) {
        ...
        try {
            ...
            log.error("enableObjectLegalHold {}", e.getMessage());
        }
    ...
    public Boolean disableObjectLegalHold(String bucketName, String objectName) {
        ...
        try {
            ...
            log.error("disableObjectLegalHold {}", e.getMessage());
        }
    ...
    public Boolean isObjectLegalHoldEnabled(String bucketName, String objectName) {
        ...
        try {
            ...
            log.error("isObjectLegalHoldEnabled {}", e.getMessage());
        }
    ...
    public Boolean removeBucket(String bucketName) {
        ...
        try {
            ...
            log.error("删除bucket异常 {}", e.getMessage());
        }
     ...
     * @throws MinioException minio异常
     */
    public String putObject(String bucketName, String baseDir, String objectName, InputStream file, String contentType) throws MinioException {
        MinioUtils.notEmpty(bucketName, ExceptionEnum.BUCKET_NAME_CANNOT_BE_EMPTY);
        MinioUtils.notEmpty(objectName, ExceptionEnum.OBJECT_NAME_CANNOT_BE_EMPTY);
        MinioUtils.notEmpty(file, ExceptionEnum.FILE_NAME_CANNOT_BE_EMPTY);
        baseDir = StrUtil.isBlank(baseDir) ? StrUtil.EMPTY
                : StrUtil.endWith(baseDir, StrUtil.SLASH) ? baseDir : baseDir + StrUtil.SLASH;
        objectName = baseDir + MinioUtils.getDateFolder() + StrUtil.SLASH + objectName;
        try {
            ...
            log.error("对象 : {} 上传异常 {}", objectName, e.getMessage());
     ...
     * @throws MinioException minio异常
     */
    public String putObject(String baseDir, String objectName, InputStream file, String contentType) throws MinioException {
        return this.putObject(minioProperties.getBucketName(), baseDir, objectName, file, contentType);
    }
     ...
     * @throws MinioException minio异常
     */
    public String putObject(String bucketName, String baseDir, String objectName, InputStream file) throws MinioException {
        return this.putObject(bucketName, baseDir, objectName, file, null);
    }
     ...
     * @throws MinioException minio异常
     */
    public String putObject(String baseDir, String objectName, InputStream file) throws MinioException {
        return this.putObject(minioProperties.getBucketName(), baseDir, objectName, file);
    }
    ...
    public String putObject(String objectName, InputStream file) throws MinioException {
        return this.putObject(minioProperties.getBucketName(), StrUtil.EMPTY, objectName, file);
    }
     ...
     * @throws MinioException minio异常
     */
    public String putObject(String bucketName, String baseDir, String objectName, MultipartFile file) throws MinioException {
        Assert.isFalse(file.isEmpty(), ExceptionEnum.FILE_NAME_CANNOT_BE_EMPTY.getValue());
        try {
            return this.putObject(bucketName, baseDir, objectName, file.getInputStream(), null);
        }catch (IOException e) {
            log.error("上传对象异常 {}", e.getMessage());
            throw new MinioException("上传对象异常", e);
        }
    }
     ...
     * @throws MinioException minio异常
     */
    public String putObject(String baseDir, String objectName, MultipartFile file) throws MinioException {
        return this.putObject(minioProperties.getBucketName(), baseDir, objectName, file);
    }
     ...
     * @throws MinioException minio异常
     */
    public String putObject(String baseDir, MultipartFile file) throws MinioException {
        Assert.isFalse(file.isEmpty(), ExceptionEnum.FILE_NAME_CANNOT_BE_EMPTY.getValue());
        String extName = FileUtil.extName(file.getOriginalFilename());
        Assert.notBlank(extName, "非法文件名称：" + file.getOriginalFilename());
        return this.putObject(minioProperties.getBucketName(), baseDir, IdUtil.fastSimpleUUID() + DateUtil.current() + StrUtil.DOT + extName, file);
    }
    ...
    public String putObject(MultipartFile file) throws MinioException {
        Assert.isFalse(file.isEmpty(), ExceptionEnum.FILE_NAME_CANNOT_BE_EMPTY.getValue());
        return this.putObject(StrUtil.EMPTY, file);
    }
     ...
     * @throws MinioException minio异常
     */
    public String putObject(String bucketName, String baseDir, String objectName, byte[] file) throws MinioException {
        return this.putObject(bucketName, baseDir, objectName, new ByteArrayInputStream(file));
    }
     ...
     * @throws MinioException minio异常
     */
    public String putObject(String baseDir, String objectName, byte[] file) throws MinioException {
        return this.putObject(minioProperties.getBucketName(), baseDir, objectName, file);
    }
     ...
     * @throws MinioException minio异常
     */
    public String putObject(String bucketName, String baseDir, String objectName, File file, String contentType) throws MinioException {
        MinioUtils.notEmpty(bucketName, ExceptionEnum.BUCKET_NAME_CANNOT_BE_EMPTY);
        MinioUtils.notEmpty(objectName, ExceptionEnum.OBJECT_NAME_CANNOT_BE_EMPTY);
        ...
        try {
            ...
            log.error("文件 : {} 上传异常,  {}", objectName, e.getMessage());
     ...
     * @throws MinioException minio异常
     */
    public String putObject(String bucketName, String baseDir, String objectName, File file) throws MinioException {
        return this.putObject(bucketName, baseDir, objectName, file, null);
    }
     ...
     * @throws MinioException minio异常
     */
    public String putObject(String baseDir, String objectName, File file, String contentType) throws MinioException {
        return this.putObject(minioProperties.getBucketName(), baseDir, objectName, file, contentType);
    }
     ...
     * @throws MinioException minio异常
     */
    public String putObject(String baseDir, String objectName, File file) throws MinioException {
        return this.putObject(minioProperties.getBucketName(), baseDir, objectName, file);
    }
     ...
     * @throws MinioException minio异常
     */
    public String putObject(String baseDir, File file) throws MinioException {
        Assert.isTrue(FileUtil.exist(file), ExceptionEnum.FILE_NAME_CANNOT_BE_EMPTY.getValue());
        String extName = FileUtil.extName(file.getName());
        Assert.notBlank(extName, "非法文件名称：" + file.getName());
        return this.putObject(baseDir, IdUtil.fastSimpleUUID() + DateUtil.current() + StrUtil.DOT + extName, file);
    }
    ...
    public String getBucketPolicy(String bucketName) throws MinioException {
        ...
        try {
            ...
            log.error("获取bucket策略异常 {}", e.getMessage());
    ...
    public Boolean setBucketPolicy(String bucketName, BucketPolicyParam bucketPolicyParam) {
        ...
        try {
            ...
            log.error("设置bucket策略异常 {}", e.getMessage());
        }
    ...
    public Boolean deleteBucketPolicy(String bucketName) {
        ...
        try {
            ...
            log.error("删除bucket 策略异常 {}", e.getMessage());
        }
    ...
    public Boolean setBucketLifecycle(String bucketName, List<LifecycleRule> rules) {
        ...
        try {
            ...
            log.error("设置 bucket生命周期异常 {}", e.getMessage());
        }
    ...
    public Boolean deleteBucketLifecycle(String bucketName) {
        ...
        try {
            ...
            log.error("删除bucket生命周期异常 {}", e.getMessage());
        }
        return Boolean.FALSE;
    }
    ...
    public LifecycleConfiguration getBucketLifecycle(String bucketName) throws MinioException {
        ...
        try {
            ...
            log.error("获取bucket生命周期异常 {}", e.getMessage());
    ...
    public NotificationConfiguration getBucketNotification(String bucketName) throws MinioException {
        ...
        try {
            ...
            log.error("获取bucket通知异常 {}", e.getMessage());
    ...
    public Boolean setBucketNotification(String bucketName, List<QueueConfiguration> queueConfigurations) {
        ...
        try {
            ...
            log.error("设置bucket 通知异常 {}", e.getMessage());
        }
    ...
    public Boolean deleteBucketNotification(String bucketName) {
        ...
        try {
            ...
            log.error("删除bucket通知异常 {}", e.getMessage());
        }
    ...
    public ReplicationConfiguration getBucketReplication(String bucketName) throws MinioException {
        ...
        try {
            ...
            log.error("删除bucket复制配置异常 {}", e.getMessage());
    ...
    public Boolean setBucketReplication(String bucketName, List<ReplicationRule> rules) {
        ...
        try {
            ...
            log.error("设置bucket复制异常 {}", e.getMessage());
        }
    ...
    public Boolean deleteBucketReplication(String bucketName) {
        ...
        try {
            ...
            log.error("删除bucket复制异常 {}", e.getMessage());
        }
    ...
    public List<NotificationRecords> listenBucketNotification(String bucketName, String prefix, String suffix, String[] events) throws MinioException {
        ...
        try {
            ...
            log.error("监听bucket的对象通知异常 {}", e.getMessage());
    ...
    public Boolean setBucketEncryption(String bucketName, SseAlgorithm sseAlgorithm) {
        ...
        try {
            ...
            log.error("bucket 设置加密异常 {}", e.getMessage());
        }
    ...
    public SseConfigurationRule getBucketEncryption(String bucketName) throws MinioException {
        ...
        try {
            ...
            log.error("获取bucket加密异常 {}", e.getMessage());
    ...
    public Boolean deleteBucketEncryption(String bucketName) {
        ...
        try {
            ...
            log.error("删除bucket加密异常 {}", e.getMessage());
        }
    ...
    public Map<String, String> getBucketTags(String bucketName) throws MinioException{
        ...
        try {
            ...
            log.error("获取bucket标签异常 {}", e.getMessage());
    ...
    public Boolean setBucketTags(String bucketName, Map<String, String> tags) {
        ...
        try {
            ...
            log.error("设置bucket标签异常 {}", e.getMessage());
        }
    ...
    public Boolean deleteBucketTags(String bucketName) {
        ...
        try {
            ...
            log.error("删除bucket标签异常 {}", e.getMessage());
        }
    ...
    public Map<String, String> getObjectTags(String bucketName, String objectName) throws MinioException {
        ...
        try {
            ...
            log.error("获取对象标签异常 {}", e.getMessage());
    ...
    public Boolean setObjectTags(String bucketName, String objectName, Map<String, String> tags) {
        ...
        try {
            ...
            log.error("设置对象标签异常 {}", e.getMessage());
        }
    ...
    public Boolean deleteObjectTags(String bucketName, String objectName) {
        ...
        try {
            ...
            log.error("删除对象标签异常 {}", e.getMessage());
        }
