...
import cn.darkjrong.core.exceptions.GoofStatefulException;
import cn.darkjrong.core.exceptions.GoofWebException;
...
public class GoofWebExceptionHandler {
     ...
     * @return {@link ResponseVO}
     */
    @ExceptionHandler(value = GoofWebException.class)
    public ResponseVO goofWebExceptionHandler(GoofWebException e) {
        log.error("goofWebExceptionHandler  {}", ExceptionUtil.stacktraceToString(e));
     ...
     * @return {@link ResponseVO}
     */
    @ExceptionHandler(value = GoofStatefulException.class)
    public ResponseVO goofStatefulExceptionHandler(GoofStatefulException e) {
        log.error("goofStatefulExceptionHandler  {}", ExceptionUtil.stacktraceToString(e));
    ...
    public ResponseVO defaultErrorHandler(Exception e) {
        ...
        if (e.getCause() instanceof GoofWebException) {
            goofWebExceptionHandler((GoofWebException) e);
        }
        ...
        if (e.getCause() instanceof GoofStatefulException) {
            goofStatefulExceptionHandler((GoofStatefulException) e.getCause());
        }
