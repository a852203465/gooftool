...
import cn.darkjrong.aliyun.oss.ImageApi;
...
import cn.darkjrong.aliyun.oss.common.enums.ImageFormatEnum;
import cn.darkjrong.aliyun.oss.common.enums.ImageProcessingEnum;
...
public class ImageApiImpl extends BaseApiImpl implements ImageApi {
    ...
    public String averageHue(String bucketName, String objectName, Long expirationTime) {
        ...
        try {
            ...
            log.error("averageHue {}", e.getMessage());
        }
