...
@ConditionalOnProperty(prefix = "goof.multipart", name = "enabled", havingValue = "true")
@ConfigurationProperties(prefix = "goof.multipart")
public class WebMvcFileUploadConfig {
